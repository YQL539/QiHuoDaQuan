...
-(void)Videomask
{
    ...
    maskImgView.image = [UIImage imageNamed:@"black"];
    
    //返回按钮
    exitBT = [UIButton buttonWithType:(UIButtonTypeSystem)];
    exitBT.frame = CGRectMake(SCREENWIDTH/8-30, SCREENHEIGHT/10, 30, 30);
    [exitBT setImage:[UIImage imageNamed:@"leftArrow"] forState:(UIControlStateNormal)];
    ...
    [self.promptLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.view.mas_top).with.offset(NAVIGATION_BAR_HEIGHT+5.5);
        make.centerX.equalTo(self.view);
        make.size.mas_equalTo(CGSizeMake(200, 36.5));
    }];
    self.promptLabel.font = [UIFont systemFontOfSize:40];
    self.promptLabel.textColor = [Util GetColor:@"ffffff"];
...
-(void)Thirdpartylogin
{
    ...
    thirdparty.font = [UIFont systemFontOfSize:15];
    thirdparty.textColor = [Util GetColor:@"ffffff"];
    thirdparty.textAlignment = NSTextAlignmentCenter;
    thirdparty.text = @"—————— 第三方登录 ——————";
    platformsarray = @[@"微信",@"QQ",@"Facebook",@"Twitter"];
    CGFloat w = 50;
    CGFloat x;
    CGFloat centerX = SCREENWIDTH/4+25;
...
- (void)loginBtnClick:(UIButton *)sender {
    ...
    if (!self.usrName.text || !_usrPwd.text || self.usrName.text.length == 0 || self.usrPwd.text.length == 0) {
        ...
        self.usrName.text = [self.usrName.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]];
        [[userModel shareDataModel] setLoginAccout:self.usrName.text];
        [[userModel shareDataModel] setLoginPassword:_usrPwd.text];
...
//
                    if ([self.passwordView.text isEqualToString: self.passwordagain.text])
                    {
                        ...
                        [self setupClickDontreturnTitle:@"提示" Message:@"两次密码不一致"];
...
-(void)leftButtonName:(UIButton*)bt thebottomView:(UIView*)view TheaboveControls:(UIView*)controls setTitle:(NSString*)string
{
    ...
    [attrs1 addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:13] range:[bt.currentTitle rangeOfString:bt.currentTitle]];
    [attrs1 addAttribute:NSForegroundColorAttributeName value:[Util GetColor:@"ffffff"] range:[bt.currentTitle rangeOfString:bt.currentTitle]];
...
-(void)rightButtonName:(UIButton*)bt thebottomView:(UIView*)view TheaboveControls:(UIView*)controls setTitle:(NSString*)string
{
    ...
    [attrs2 addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:13] range:[bt.currentTitle rangeOfString:bt.currentTitle]];
    [attrs2 addAttribute:NSForegroundColorAttributeName value:[Util GetColor:@"ffffff"] range:[bt.currentTitle rangeOfString:bt.currentTitle]];
...
-(void)buttonName:(UIButton*)bt thebottomView:(UIView*)view TheaboveControls:(UIView*)controls setTitle:(NSString*)string
{
    ...
    [bt setBackgroundImage:[UIImage imageNamed:@"pink"] forState:UIControlStateNormal];
    [bt setBackgroundImage:[UIImage imageNamed:@"pink"] forState:UIControlStateHighlighted];
    [bt setTitle:string forState:(UIControlStateNormal)];
}
...
-(void)InputboxView:(UIView*)userView leftimage:(NSString*)leftimage TextField:(UITextField*)textField placeholder:(NSString*)placeholder
{
    ...
    bgImgView1.image = [UIImage imageNamed:@"box"];
    ...
    iconImgView1.image = [UIImage imageNamed:leftimage];
...
//    textField = [[UITextField alloc] init];
    ...
    textField.textColor = [Util GetColor:@"ffffff"];
    ...
    [attrsPlaceholder1 addAttribute:NSForegroundColorAttributeName value:[Util GetColor:@"e5e5e5"] range:NSMakeRange(0, placeholder1.length)];
