...
#define kCollectArticle @"CollectArticle"

#define KeyWordsSeparator  @"<---->"
#define  CANCERSTR @"cancerStr"

#define KPUBLICKKEY [Util GetPublicKey]
#define KGETENCODESTRING [Util GetEncodeSting]
